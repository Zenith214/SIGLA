...
7. [Officer Guide](#officer-guide)
8. [Viewer Guide](#viewer-guide)
9. [Dashboard Features](#dashboard-features)
10. [CPAP System Guide](#cpap-system-guide)
...
- Improve barangay-level governance performance with data-driven insights
...
- Maps: Interactive SVG maps with Leaflet.js integration
- ML Analytics: Python-based machine learning service for satisfaction scoring
...
1. Enter your email address and password provided by your administrator
2. You may be prompted to change your password for security
3. Review the welcome guide if displayed
4. Familiarize yourself with the navigation menu and available features
5. Check the active survey cycle displayed in the header
...
| Officer | CPAP creation, action planning, implementation | Own barangay | View survey results, create/edit/submit CPAP, track implementation |
| Viewer | View-only access to dashboards and analytics | Read-only access | View dashboard, analytics, report cards (no editing) |
...
- Setting up and managing survey cycles
- Managing barangays and their information
...
- Conducting face-to-face surveys with citizens
...
Important: Do not substitute the selected respondent. If they're unavailable, schedule a callback.
...
- Suggestions: Open-ended feedback
...
- Each survey takes approximately 20-30 minutes
...
1. Financial Administration (Score: 0-100)
   - Projects and programs effectiveness
   - Financial transparency
   - Social assistance programs
   - Anti-corruption measures

2. Disaster Preparedness (Score: 0-100)
   - Information dissemination
   - Evacuation center quality
   - Emergency response

3. Social Protection (Score: 0-100)
   - Health services accessibility
   - Protection services
   - Community participation
   - Senior citizen support

4. Safety and Peace (Score: 0-100)
   - Peace and order programs
   - Crime prevention
   - Conflict resolution

5. Business-Friendly (Score: 0-100)
   - Business permit processing
   - Business support programs
   - Market facilities

6. Environmental Management (Score: 0-100)
   - Waste management
   - Environmental programs
...
5. Governance Integrity Snapshot
...
1. Results/Observations: What the survey data shows
2. Plan of Action: High-level strategy to address the issue
3. Activity: Specific activities to implement
4. Output (REQUIRED): Expected deliverable or outcome
5. Actual Output: What was actually achieved (filled during implementation)
6. Status of Accomplishment: Current status (Ongoing/Delayed/Completed)
7. Implementation Schedule: Timeline for completion
8. Actual Date: When actually completed
9. Financial Requirements: Budget needed
10. Responsible Person/Office: Who will implement
11. Committed/To be Committed: Funding status
...
Draft → Submitted → Approved (or Revision Requested)
...
1. System analyzes your barangay's survey data
2. Identifies areas with:
   - Low satisfaction scores
   - High need-for-action percentages
   - Common citizen complaints
   - Critical issues
3. Generates specific, actionable recommendations
4. Organizes by timeframe (short/medium/long-term)
...
1. Overall Satisfaction Index: Average across all barangays
2. Total Responses: Number of surveys completed
3. Target Achievement: Percentage of targets met
4. Survey Progress: Overall completion rate
5. Active Barangays: Number with ongoing surveys

Leaderboards:
- Top Performers: Barangays with highest satisfaction
- Most Improved: Biggest increase from previous cycle
- Needs Attention: Lowest satisfaction scores
...
- High Awareness, Low Availment: Services exist but not accessible
- High Availment, Low Satisfaction: Services used but poor quality
- Low Awareness: Need better information dissemination
...
3. Use browser print function (Ctrl+P)
...
A: Click the Print button on the report card page, then use your browser's print function (Ctrl+P).
...
- Interactive SVG map with hover and click features
