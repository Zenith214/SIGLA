    ...
    case "financial":
      return [
        ...
        createNonAvailmentReasonQuestion("socialPrograms", "awarenessSocialPrograms", "participatedSocialPrograms", "filipino"),
        {
          ...
          type: "radio",
          ...formatQuestionText("11. KASIYAHAN:\nBatay sa iyong karanasan o obserbasyon, gaano ka nasisiyahan sa paghahatid at epekto ng mga programang panlipunan ng barangay? / Based on your experience or observation, how satisfied are you with the delivery and impact of these social programs?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
    ...
    case "disaster":
      return [
        ...
        createNonAvailmentReasonQuestion("disasterInfo", "awarenessDisasterInfo", "availmentDisasterInfo", "english"),
        {
          ...
          type: "radio",
          ...formatQuestionText("3. SATISFACTION:\nHow satisfied are you with the clarity, timeliness, and effectiveness of the disaster warnings and information provided by the barangay? / How satisfied are you with the clarity, timeliness, and effectiveness of the disaster warnings and information provided by the barangay?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
        ...
        // Part B: Evacuation and Emergency Response Resources
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "endOfDisasterSection" } // STOP this section
          ]
        },
        {
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("7. SATISFACTION:\nBased on what you know or have seen, how confident and satisfied are you with the readiness of our barangay's evacuation facilities and emergency response capabilities (e.g., rescue team, equipment)? / Based on what you know or have seen, how confident and satisfied are you with the readiness of our barangay's evacuation facilities and emergency response capabilities (e.g., rescue team, equipment)?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
    ...
    case "safety":
      return [
        // Part A: General Safety and Barangay Tanod (Peacekeeper) Services
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "awarenessLupon" } // Skip to Q5 (start of Part B)
          ]
        },
        {
          id: "experienceTanods",
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("3. SATISFACTION:\nHow satisfied are you with the visibility, responsiveness, and effectiveness of our Barangay Tanods in keeping the community safe? / How satisfied are you with the visibility, responsiveness, and effectiveness of our Barangay Tanods in keeping the community safe?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
        ...
        // Part B: Community Dispute Resolution (Lupon)
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "awarenessAntiDrug" } // Skip to Q9 (start of Part C)
          ]
        },
        {
          id: "experienceLupon",
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("7. SATISFACTION:\nBased on your experience or what you've heard, how satisfied are you with the fairness and effectiveness of the barangay's dispute settlement process? / Based on your experience or what you've heard, how satisfied are you with the fairness and effectiveness of the barangay's dispute settlement process?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
        ...
        // Part C: Anti-Illegal Drug Programs
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "endOfSafetySection" } // STOP this section
          ]
        },
        {
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("11. SATISFACTION:\nHow satisfied are you with the barangay's overall efforts to address the issue of illegal drugs within our community? / How satisfied are you with the barangay's overall efforts to address the issue of illegal drugs within our community?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
    ...
    case "social":
      return [
        // Part A: Barangay Health Services
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "awarenessWomenChildrenProtection" } // Skip to Q5 (start of Part B)
          ]
        },
        {
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("3. SATISFACTION:\nHow satisfied are you with the quality, availability, and staff service at our Barangay Health Station? / How satisfied are you with the quality, availability, and staff service at our Barangay Health Station?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
        ...
        // Part B: Protection Services for Women and Children
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "awarenessCommunityParticipation" } // Skip to Q9 (start of Part C)
          ]
        },
        {
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("7. SATISFACTION:\nHow confident and satisfied are you in the barangay's ability to provide a safe, confidential, and effective response to protect women and children? / How confident and satisfied are you in the barangay's ability to provide a safe, confidential, and effective response to protect women and children?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
        ...
        // Part C: Community Participation and Development
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "endOfSocialSection" } // STOP this section
          ]
        },
        {
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("11. SATISFACTION:\nHow satisfied are you with the opportunities the barangay provides for residents to get involved in community life and development? / How satisfied are you with the opportunities the barangay provides for residents to get involved in community life and development?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
    ...
    case "business":
      return [
        // Part A: Issuance of Barangay Clearance for Business
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "endOfBusinessSection" } // STOP this section
          ]
        },
        {
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("3. SATISFACTION:\nHow satisfied were you with the overall process of getting the clearance, considering the speed of service, the fees, and the helpfulness of the staff? / How satisfied were you with the overall process of getting the clearance, considering the speed of service, the fees, and the helpfulness of the staff?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
    ...
    case "environmental":
      return [
        // Part A: Solid Waste Management (Garbage Collection & Segregation)
        {
          ...
          required: true,
          conditionalNext: [
            { value: "No", skipToId: "endOfEnvironmentalSection" } // STOP. End of survey.
          ]
        },
        {
        ...
        },
        {
          ...
          type: "radio",
          ...formatQuestionText("3. SATISFACTION:\nHow satisfied are you with the barangay's overall solid waste management, considering the reliability of the collection schedule, the effectiveness of the segregation policy, and the general cleanliness of the community? / How satisfied are you with the barangay's overall solid waste management, considering the reliability of the collection schedule, the effectiveness of the segregation policy, and the general cleanliness of the community?"),
          options: ["5", "4", "3", "2", "1"],
          required: true,
