/**
 * Questions Updater Utility
 * 
 * This utility provides a comprehensive update to the questions structure
 * to include the new conditional modules for unawareness and non-availment reasons.
 */
...
/**
 * Get updated questions for all sections with conditional modules integrated
 */
export function getUpdatedQuestionsForSection(sectionId: string): Question[] {
  ...
  switch (sectionId) {
    ...
    case "disaster":
      return [
        ...
        // ... rest of disaster questions with similar pattern
      ];
