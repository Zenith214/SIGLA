  ...
  return (
    <div className="min-h-screen bg-blue-50">
        ...
        {currentView === "map" && (
          <div className={isFullScreen ? "h-full p-4" : "h-full"}>
            ...
            <Card className="bg-card border-border shadow-sm h-full flex flex-col">
              ...
              <CardContent className={`flex-1 ${isFullScreen ? "h-full" : ""}`} >
                <div className={`relative w-full ${isFullScreen ? "h-full" : "h-96"} bg-primary-light rounded-lg border-2 border-dashed border-border overflow-hidden flex`}>
                  {/* Map Background */}
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-40 w-12 h-12 bg-primary hover:bg-primary/90 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center group ${isFullScreen ? "hidden" : ""}`}
