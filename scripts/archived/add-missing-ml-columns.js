...
async function addMissingColumns() {
  ...
  try {
    ...
    `);
    console.log(
      "✅ action_grid_classification test:",
      testActionGrid.rows.length > 0 ? "Working" : "No data"
    );
    ...
    console.log(
      "✅ ai_insight test:",
      testInsight.rows.length > 0 ? "Working" : "No data"
    );
    ...
    console.log(
      ...
      testRecommendation.rows.length > 0 ? "Working" : "No data"
    );
