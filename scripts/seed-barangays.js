...
const barangayData = [
  ...
  },
  {
    ...
    area: 10.4,
    currentStatus: "Completed",
    is_awardee: true, // Good performance
  ...
  },
  {
    ...
    area: 14.1,
    currentStatus: "Completed",
    is_awardee: true, // High performing
  ...
  },
  {
    ...
    area: 20.3,
    currentStatus: "Completed",
    is_awardee: true, // Highest performing - town center
...
async function seedBarangays() {
  ...
  console.log('🌱 Seeding barangays with real data...');
  ...
  console.log(`🏆 Awardees: ${barangayData.filter(b => b.is_awardee).length}`);
}
